            ...
            <div class="container px-4 px-lg-5">
                <div class="row gx-4 gx-lg-5 justify-content-center">
                    <div class="col-lg-8 text-left">
                        <h2 class="text-white mt-0"><strong style={{fontFamily:'SKYBORI', fontSize:50}}>기관 소개</strong></h2>
                        <hr className="hr-long" />
                        <div style={{ justifyContent: 'left', display: 'flex', marginBottom: '2%' }}>
                            <svg className="svg-icon" xmlns="http://www.w3.org/2000/svg" width="20" height="45" viewBox="0 0 18 45" fill="none" >
                                <path d="M4 13.0557L14 3.61121V41.389" stroke="white" stroke-width="7" stroke-linecap="round" stroke-linejoin="round" />
                            </svg>
                            <p class="text-white-75 mb-4" style={{marginTop:'1%', marginLeft:'1%', fontWeight:'bold', fontSize:25}}>절차가 간편한 음식 기부 활동을 진행 할 수 있습니다.</p>
                        </div>
                        <div style={{ justifyContent: 'left', display: 'flex' }}>
                            <svg className="svg-icon" xmlns="http://www.w3.org/2000/svg" width="30" height="45" viewBox="0 0 28 45" fill="none">
                            ...
                            <p class="text-white-75 mb-4" style={{fontWeight:'bold', fontSize:25}}>휴대폰 앱을 사용하여 쉽고 빠르고 간편하게<br></br> 기부 활동을 할 수 있습니다.</p>
                        </div>
                        <div style={{ justifyContent: 'left', display: 'flex' }}>
                            <svg className="svg-icon" xmlns="http://www.w3.org/2000/svg" width="30" height="45" viewBox="0 0 28 45" fill="none">
                            ...
                            <p class="text-white-75 mb-5" style={{fontWeight:'bold', fontSize:25}}>소상공인의 음식물 낭비를 줄이고 선한 영향력을 발휘하여<br></br>기부 인증 스티커를 발급받을 수 있습니다.</p>
                        </div>
                    </div>
