                ...
                <div class="row gx-4 gx-lg-5 justify-content-center" style={{marginTop:'10%'}}>
                    <div class="col-lg-8 text-left">
                        ...
                        <div style={{ justifyContent: 'left', display: 'flex', marginBottom: '2%', marginTop:'10%' }}>
                            ...
                            <p class="text-white-75 mb-4" style={{marginTop:'1%', marginLeft:'1%', fontWeight:'bold', fontSize:25}}>소상공인분들이 쉽게 음식을 나눔할 수 있습니다.</p>
                        </div>
                        <div style={{ justifyContent: 'left', display: 'flex' }}>
                            ...
                            <p class="text-white-75 mb-4" style={{fontWeight:'bold', fontSize:25}}>휴대폰 앱을 사용하여 쉽고 빠르고 간편하게 나눔 활동을 할 수 있습니다.</p>
                        </div>
                        <div style={{ justifyContent: 'left', display: 'flex' }}>
